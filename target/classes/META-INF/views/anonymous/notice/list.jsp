...
<acme:list>
	...
	<acme:list-column code="anonymous.notice.list.label.creation" path="creation" width="25%"/>
	<acme:list-column code="anonymous.notice.list.label.deadline" path="deadline" width="25%"/>
	<acme:list-column code="anonymous.notice.list.label.links" path="links" width="25%"/>
</acme:list>
