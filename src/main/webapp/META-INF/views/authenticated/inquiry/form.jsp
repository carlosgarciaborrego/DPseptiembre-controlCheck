...
<acme:form readonly="true">
	...
	<acme:form-money code="authenticated.inquiry.form.label.minPrice" path="minPrice"/>
	<acme:form-money code="authenticated.inquiry.form.label.maxPrice" path="maxPrice"/>
