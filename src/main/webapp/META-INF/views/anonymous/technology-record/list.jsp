...
<acme:list>
	...
	<acme:list-column code="anonymous.technologyRecord.list.label.email" path="email" width="35%"/>
	<acme:list-column code="anonymous.technologyRecord.list.label.stars" path="stars" width="20%"/>
</acme:list>
