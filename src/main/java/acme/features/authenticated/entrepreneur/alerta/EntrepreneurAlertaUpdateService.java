...
@Service
public class EntrepreneurAlertaUpdateService implements AbstractUpdateService<Entrepreneur, Alerta> {
	...
	@Override
	public void update(final Request<Alerta> request, final Alerta entity) {
		assert request != null;
		assert entity != null;
