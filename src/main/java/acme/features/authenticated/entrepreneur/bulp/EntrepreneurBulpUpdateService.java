...
@Service
public class EntrepreneurBulpUpdateService implements AbstractUpdateService<Entrepreneur, Bulp> {
	...
	@Override
	public void update(final Request<Bulp> request, final Bulp entity) {
		assert request != null;
		assert entity != null;
